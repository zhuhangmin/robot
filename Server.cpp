...
BOOL CMainServer::Initialize()
{
	...
	g_pSvrInOut->Init(g_szIniFile, g_pSockServer, PORT_ROBOT_SERVER, "robotsvr");
 	////////////////////////////////////////////////////////
	StartServer();
	return TRUE;
}
BOOL CMainServer::StartServer()
{
	...
	if (SystemInfo.dwNumberOfProcessors > MAX_PROCESSORS_SUPPORT)
	{
		...
		return g_pSockServer->Initialize(_T(""), nRobotPort,
...
#define MAIN_XXX_GAP_TIME (10*60) // 10分钟
